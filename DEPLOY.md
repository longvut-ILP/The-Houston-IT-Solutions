...
2. **Root Directory** = `Nail Employee salary` (the API folder). Framework preset: **Other**.
...
- [ ] API = 2nd Vercel project (root `Nail Employee salary`), env vars set, `/health` ok (Part 3)
